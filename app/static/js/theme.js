// theme.js - Gerencia o modo Claro/Escuro (Light/Dark mode)
document.addEventListener('DOMContentLoaded', () => {
    ...
    function setTheme(theme) {
        if (theme === 'dark') {
            ...
            // Atualizar ícones (mostrar sol no modo escuro)
            ...
            // Atualizar ícones (mostrar lua no modo claro)
            themeToggleBtns.forEach(btn => {
    ...
    // Carregar tema salvo ou usar a preferência do sistema
